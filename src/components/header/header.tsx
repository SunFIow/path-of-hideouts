...
import { APP_NAME, REPOSITORY_URL } from '@/constant/constants';
...
export default function Header() {
	...
	return (
		<header className='sticky left-0 top-0 z-50 w-full border-b border-app-accent/80 bg-app/90 px-4 py-3 backdrop-blur'>
			<nav className='flex items-center justify-between'>
				...
				<a href='/' className='flex items-center gap-3'>
					...
					<img src='icon.png' alt='' width={26} height={26} style={{ imageRendering: 'pixelated' }} />
					<div>
						<p className='font-display text-2xl leading-none'>{APP_NAME}</p>
						<p className='text-xs uppercase tracking-[0.24em] text-font-faded'>Hideout planner</p>
					</div>
				</a>
